//一、自动化维护，减少了手工维护的成本和风险，提升了开发体验
	...
	//担心代码质量，需要做检查
	//1.举一个例子，开发时都是在一个目录下，资源定位都是相对地址，上线后，需要
	//将相对地址改成绝对地址，js还好说，可以定义一个变量，
	//上线时手工更改变量，或者写入配置信息条件判断，就可以。那么css呢，所有的url都是分散的，应该怎么改，用编辑器查找改，用less写一个变量，类似于js的编程方式改。这都不是成熟的。

    //开发时只关心源码，上线代码部署，无论是域名变动啊，还是文件路径变动
    //，都不关心，这些都是自动化的，而且，不仅仅是js，css，还有图片，
    //一切的静态资源都做到了自动管理。
